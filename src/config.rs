...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("suporteremoto.dyalog.com.br".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Aliff Suporte".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["suporteremoto.dyalog.com.br"];
pub const RS_PUB_KEY: &str = "PLN7WitQBaVpkh69EcqhdyMf278Fd+cfLcpc9CDL5l4=";
